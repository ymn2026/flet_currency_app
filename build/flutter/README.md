...
* `flet_currency_app` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `flet_currency_app` - executable or bundle name on disk.
* `flet_currency_app` - display name shown in window titles and about app dialogs.
